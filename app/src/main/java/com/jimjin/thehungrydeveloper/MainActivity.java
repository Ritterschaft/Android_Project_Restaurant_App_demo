package com.jimjin.thehungrydeveloper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainsCard.setOnClickListener(view -> {
            Intent mainCourseActivityIntent = new Intent(MainActivity.this,MainCoursesActivity.class);
        ...
        emailTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                launchEmailAppIntent.setData(Uri.parse("mailto:thehungrydeveloper@jimjin.com")); // only email apps should handle this
